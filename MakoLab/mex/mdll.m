function [methodinfo,structs,enuminfo,ThunkLibName]=mdll
%MDLL Create structures to define interfaces found in 'armdll32'.

%This function was generated by loadlibrary.m parser version 1.1.6.37 on Thu Dec 18 16:27:35 2014
%perl options:'armdll32.i -outfile=mdll.m -thunkfile=armdll64_thunk_pcwin64.c -header=armdll32.h windows.h'
ival={cell(1,0)}; % change 0 to the actual number of functions to preallocate the data.
structs=[];enuminfo=[];fcnNum=1;
fcns=struct('name',ival,'calltype',ival,'LHS',ival,'RHS',ival,'alias',ival,'thunkname', ival);
MfilePath=fileparts(mfilename('fullpath'));
ThunkLibName=fullfile(MfilePath,'armdll64_thunk_pcwin64');
%  int __stdcall ArmStart ( uint32_T hwndParent ); 
fcns.thunkname{fcnNum}='int32uint32_TThunk';fcns.name{fcnNum}='ArmStart'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'error'};fcnNum=fcnNum+1;
...
%  int __stdcall ArmSetUpdateEx ( int type , uint32_T minUpdatePeriodms ); 
fcns.thunkname{fcnNum}='int32int32uint32_TThunk';fcns.name{fcnNum}='ArmSetUpdateEx'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int32', 'error'};fcnNum=fcnNum+1;
...
%  int __stdcall ArmGetProductName ( char * szProductName , uint32_T uiBufferLength ); 
fcns.thunkname{fcnNum}='int32cstringuint32_TThunk';fcns.name{fcnNum}='ArmGetProductName'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'cstring', 'error'};fcnNum=fcnNum+1;
%  int __stdcall ArmGetSerialNumber ( char * szSerialNumber , uint32_T uiBufferLength ); 
fcns.thunkname{fcnNum}='int32cstringuint32_TThunk';fcns.name{fcnNum}='ArmGetSerialNumber'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'cstring', 'error'};fcnNum=fcnNum+1;
%  int __stdcall ArmGetModelName ( char * szModelName , uint32_T uiBufferLength ); 
fcns.thunkname{fcnNum}='int32cstringuint32_TThunk';fcns.name{fcnNum}='ArmGetModelName'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'cstring', 'error'};fcnNum=fcnNum+1;
%  int __stdcall ArmGetVersion ( char * szArmDllVersionNumber , char * szFirmwareVersionNumber , uint32_T uiBufferLength ); 
fcns.thunkname{fcnNum}='int32cstringcstringuint32_TThunk';fcns.name{fcnNum}='ArmGetVersion'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'cstring', 'cstring', 'error'};fcnNum=fcnNum+1;
...
%  int __stdcall ArmGetButtonsState ( int * pdwButtonsState ); 
fcns.thunkname{fcnNum}='int32voidPtrThunk';fcns.name{fcnNum}='ArmGetButtonsState'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int32Ptr'};fcnNum=fcnNum+1;
...
%  int __stdcall ArmGetFullTip ( length_3D * pPosition , angle_3D * vecT0 , angle_3D * vecT1 , angle_3D * vecT2 , int * pdwButtonsState ); 
fcns.thunkname{fcnNum}='int32voidPtrvoidPtrvoidPtrvoidPtrvoidPtrThunk';fcns.name{fcnNum}='ArmGetFullTip'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'length_3DPtr', 'angle_3DPtr', 'angle_3DPtr', 'angle_3DPtr', 'int32Ptr'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='int32voidPtrvoidPtrint32voidPtrThunk';fcns.name{fcnNum}='ArmGenerateTipPositionOffset'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'length_3DPtr', 'angle_3DPtr', 'int32', 'length_3DPtr'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='int32voidPtrvoidPtrint32voidPtrvoidPtrThunk';fcns.name{fcnNum}='ArmGenerateTipPositionOffsetEx'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'length_3DPtr', 'angle_3DPtr', 'int32', 'length_3DPtr', 'angle_3DPtr'};fcnNum=fcnNum+1;
...
structs.device_status.members=struct('status', 'int32', 'Baud', 'error', 'PortNumber', 'error');
